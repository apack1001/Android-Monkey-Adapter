...
public class MonkeyTestSeriesFactory {
    ...
    public static Map<MonkeyTestDevice, MonkeyTestSeries> mBuffer = 
    		new HashMap<MonkeyTestDevice, MonkeyTestSeries>();

    public static MonkeyTestSeries newSeries(
    	...
    	mBuffer.put(device, new MonkeyTestSeries(
    			device, 
    			pkgName, 
    			pkgVersion, 
    			pkgFilePath,
